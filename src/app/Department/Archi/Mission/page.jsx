        ...
        <div className="w-full px-5 xs:px-0 md:w-[90%] lg:w-[80%] mx-auto">
          ...
          <p className="text-justify mt-2">
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li className="ml-4">
                To develop the department as the regional centre of knowledge
                and information in Architecture and Planning.
              </li>
              <li className="ml-4">
              ...
              <li className="ml-4">
                To undertake joint initiatives that offer opportunities for
