...
import StaffcardDept from "../../../../components/facultycomponents/StaffcardDept";
import staffData from "../staffArchi";

const ArchiStaffpage = () => {
  const [staff, setStaff] = useState("staff");
  const hasStaff =
    staffData.find((dept) => dept.department === "Architecture and Planning")
      ?.staff.length > 0;
